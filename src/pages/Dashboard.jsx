            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                <GlassCard className="md:col-span-2 bg-gradient-to-br from-primary/20 to-surface border-primary/20">
                    <div className="flex items-center justify-between">
                        <div>
                            <h2 className="text-2xl font-bold text-white mb-1">Welcome back, Coffee Lover!</h2>
                            <p className="text-text-muted">You have <span className="text-primary font-bold text-lg">150</span> points</p>
                        </div>
                    ...
                    <div className="mt-6">
                        ...
                        <p className="text-xs text-right mt-2 text-text-muted">50 points to next reward</p>
                    </div>
                </GlassCard>
